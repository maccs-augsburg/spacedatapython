# clean_remove_records.py
#
# 2020 August - Created - Erik Steinmetz
#

""" Cleaned Record Remover

Proceeds through a cleaned 2 Hz MACCS data file writing a new cleaned
file with the designated records removed.
